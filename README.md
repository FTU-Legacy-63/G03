...
| Pricing Method<br><br> | Phương thức xác định lãi suất trúng thầu | Categorical<br> |  | Single-price | Single-price / Multi-price<br> |
...
Logic: User’s OMO Decision → Commercial Banks Submit Bids → Auction Allocation → Realized Supply / Withdrawal + Maturity → Total Supply Volume → Liquidity Gap → Liquidity Pressure → Liquidity adjusted volume (Total Supply Volume adjusted by Liquidity pressure) → Interbank Rate
